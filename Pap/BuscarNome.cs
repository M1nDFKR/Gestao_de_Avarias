        ...
        public bool BuscarNaBD()
        {
            ...
            try
            {
                using (MySqlConnection ConexaoBasedeDados = new MySqlConnection(ConexaoBD.basededados))
                {
                    ...
                    WHERE
                        Utilizador.Nome LIKE @valor
                        OR Utilizador.NomeEE LIKE @valor
                        OR Utilizador.EmailEE LIKE @valor;";
                        ...
                        using (MySqlDataReader reader = comandoSql.ExecuteReader())
                        {
                            ...
                            while (reader.Read())
                            {
                                string[] row =
                                {
                                    ...
                                    reader.IsDBNull(reader.GetOrdinal("HrContacto")) ? "" : reader.GetTimeSpan(reader.GetOrdinal("HrContacto")).ToString(@"hh\:mm\:ss"),
